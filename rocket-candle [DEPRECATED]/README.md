...
2. **Frontend Configuration**
   ...
   **Required Frontend Environment Variables:**
   ...
   VITE_ROCKET_CANDLE_CONTRACT=0x7e045E5591Cfd42208a08D0cd89218218cD4c8C5
   VITE_ROCKET_FUEL_CONTRACT=0x7c1EeBF05f80D74B002dC8a8BDD72c44143c798f
   VITE_ROCKET_CANDLE_SCORES_CONTRACT=0xB6D82716996DA655ab62A1D78859Ac86f318a132

   # WalletConnect Project ID (get from https://walletconnect.com/)
...
3. **Backend Configuration**
   ...
   **Required Backend Environment Variables:**
   ...
   # Contract Addresses
   ROCKET_CANDLE_ADDRESS=0x7e045E5591Cfd42208a08D0cd89218218cD4c8C5
   ROCKET_FUEL_ADDRESS=0x7c1EeBF05f80D74B002dC8a8BDD72c44143c798f
   ROCKET_CANDLE_SCORES_ADDRESS=0xB6D82716996DA655ab62A1D78859Ac86f318a132

   # Private Key for Server Operations (Replace with your private key)
...
3. **Update Environment Variables**
   After deployment, update the contract addresses in both frontend and backend `.env` files.
...
│   │   ├── blocks/      # Candlestick and destructible block sprites
│   │   ├── buttons/     # Control key sprites
│   │   ├── enemies/     # Enemy character variants
│   │   └── ...
│   └── css/             # Stylesheets
├── src/                 # Source code
│   ├── scenes/          # Phaser game scenes
│   ├── services/        # Web3 and wallet services
│   ├── components/      # UI components
│   ├── config/          # Configuration files
│   └── utils/           # Utility functions
├── rocket-candle-backend/ # Express.js API server
│   ├── .env             # Backend environment variables
│   └── server.js        # Main server file
└── rocket-candle-contracts/ # Solidity smart contracts
...
- `VITE_MONAD_CHAIN_ID`: Blockchain chain ID (10143)
- `VITE_ROCKET_CANDLE_CONTRACT`: Main game contract address
- `VITE_ROCKET_FUEL_CONTRACT`: FUEL token contract address
- `VITE_ROCKET_CANDLE_SCORES_CONTRACT`: Scores contract address
...
- `MONAD_RPC_URL`: Blockchain RPC endpoint
- `PRIVATE_KEY`: Server wallet private key for contract interactions
